...
def test_visualized_run():
    ...
    model.apple_source.max_entities = MAX_ENTITIES
    model.pear_source.max_entities = MAX_ENTITIES
    ...
    assert (
        model.pear_sink.overall_count_in + model.apple_sink.overall_count_in
    ) == MAX_ENTITIES * 2
