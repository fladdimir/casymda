...
from examples.resources.resource_example_model import Model
...
def test_visualized_run():
    ...
    visualizer = ProcessVisualizer(
        ...
        background_image_path="examples/resources/resource_example.png",
        default_entity_icon_path="examples/resources/simple_entity_icon.png",
    )
